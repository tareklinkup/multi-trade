    ...
    template: `
        <div>
            ...
            <div class="row" style="margin-top:10px">
                <div class="col-xs-12">
                    <lable for="vehicle1">Print Details</lable>
                   <input type="checkbox"  id="vehicle1"  v-model="allPrint">
                </div>
            </div>
            <div id="invoiceContent">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-5 text-right">
                        ...
                        <strong>Attention:</strong> {{ sales.attention }}
                    </div>
                </div>
                <div class="row">
                    <div class="col-xs-12">
                ...
                <div class="row">
                    <div v-bind:style="{display: this.allPrint == true ? '' : 'none'}">
                        <table _a584de>
                            <thead>
                                <tr>
                                    ...
                                    <td rowspan="1">Qnty</td>
                                    <td rowspan="1">Sqr Qnty</td>
                                    <td rowspan="1">Unit</td>
                                </tr>
                            </thead>
                            <tbody>
                               
                                <tr v-if="product.height != 0 && product.width != 0" v-for="(product, sl) in cart">
                                  
                                    <td>{{ product.description }}</td>
                                    <td>{{ product.location }}</td>
                                    <td>{{ product.Product_Name }}</td>
                                    <td v-if="product.height != 0 && product.width != 0">{{ product.height }} * {{product.width}}</td>
                                    <td v-else>-</td>
                                    <td>{{ product.sqr_qnty }}</td>
        ...
        async print(){
            ...
            if (this.currentBranch.print_type == '3') {
                    ...
                    <html>
                        ...
                        <body>
                            <div style="text-align:center;">
                                <img src="/uploads/branch/${this.currentBranch.image}" alt="Logo" style="height:80px;margin:0px;" /><br>
                ...
                printWindow.document.write(`
                    ...
                    <body>
                        <div class="row">
                            <div class="col-xs-2"><img src="/uploads/branch/${this.currentBranch.image}" alt="Logo" style="height:80px;" /></div>
