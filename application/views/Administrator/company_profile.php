		...
		<div class="col-sm-6 col-sm-offset-1">
			<div id="branch">
				<div class="row" style="margin-top: 15px;">
					<div class="col-md-12">
						<form class="form-horizontal" @submit.prevent="saveBranch" enctype="multipart/form-data">
							<div class="form-group">
							...
							<div class="form-group">
								<label class="col-sm-3 control-label no-padding-right"> Branch Image </label>
								<label class="col-sm-1 control-label no-padding-right">:</label>
								<div class="col-sm-5">
									<input type="file" v-on:change="onImageChange">
								</div>
								<div class="col-sm-5" style="padding-top:10px">
								<img style="height:100px; width:100px" v-if="this.selectedFile != null || url != null" :src="url">
								</div>
							</div>
						...
						<table class="table table-bordered">
							...
							<tbody>
								<tr v-for="(branch, sl) in branches">
									...
									<td v-if="branch.image != null"> <img  style="height:50px; width:50px;" :src="'/uploads/branch/'+branch.image" alt=""></td>
									<td v-else> <img  style="height:50px; width:50px;" :src="'assets/no_image.gif'" alt=""></td>
    ...
    new Vue({
        ...
        data(){
            return {
				...
				selectedFile : '',
                url: '<?php echo base_url();?>assets/no_image.gif',
                branches: []
            }
        },
        created(){
        ...
        methods: {
            ...
            editBranch(branch){
				...
				this.url = '/uploads/branch/'+branch.image;
            },
