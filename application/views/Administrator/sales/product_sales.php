...
<div id="sales" class="row">
    <div class="col-xs-12 col-md-12 col-lg-12" style="border-bottom:1px #ccc solid;margin-bottom:5px;">
        <div class="row">
            ...
            <div class="form-group ">
                <label class="col-sm-1 control-label no-padding-right"> Attention </label>
                <div class="col-sm-2">
                    <input type="text" class="form-control" v-model="sales.attention">
                </div>
            </div>
                        ...
                        <div class="col-sm-5">
                            <form v-on:submit.prevent="addToCart">
                                ...
                                <div style="display:none;"
                                    v-bind:style="{display: selectedProduct.Unit_Name == 'PCS' ? 'none' : '' }">
                                    <div class="form-group" v-if="selectedProduct.is_sqr != 0">
                                        <label class="col-xs-3 control-label no-padding-right"> Height </label>
                                        <div class="col-xs-3">
                                            <input type="number" placeholder="Qty" step="0.01"
                                                v-model="selectedProduct.height" class="form-control" autocomplete="off"
                                                v-on:input="sqrTotal" />
                                        </div>
                                        <label class="col-xs-3 control-label no-padding-right"> Width </label>
                                        <div class="col-xs-3">
                                            <input type="number" placeholder="Qty" class="form-control"
                                                v-model="selectedProduct.width" step="0.01" autocomplete="off"
                                                v-on:input="sqrTotal" />
                                        </div>
                                    </div>
                                    <div class="form-group" v-if="selectedProduct.is_sqr != 0">
                                        <label class="col-xs-3 control-label no-padding-right">Sqr Qnty</label>
                                        <div class="col-xs-9">
                                            <input type="number" step="0.01" class="form-control"
                                                v-model="selectedProduct.sqr_qnty" v-on:input="sqrTotal" />
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-9" v-if="selectedProduct.is_sqr != 0">
                ...
                <table class="table table-bordered" style="color:#000;margin-bottom: 5px;">
                    <thead>
                        <tr class="">
                            ...
                            <th style="width:15%;color:#000;">Location</th>
                                            ...
                                            <div class="form-group">
                                                <div class="col-xs-6">
                                                    <input type="button" class="btn btn-default btn-sm" value="Sale"
                                                        ...
                                                        style="color: black!important;margin-top: 0px;width:100%;padding:5px;font-width:bold;">
                                                </div>
                                                <div class="col-xs-6">
                                                    <a class="btn btn-info btn-sm"
                                                        v-bind:href="`/sales/${sales.isService == 'true' ? 'service' : 'product'}`"
                                                        style="color: black!important;margin-top: 0px;width:100%;padding:5px;font-width:bold;">New
                                                        Sale</a>
                                                </div>
                                            </div>
                                        </td>
...
new Vue({
    ...
    methods: {
        ...
        sqrTotal() {
            if (this.selectedProduct.is_sqr != 0) {
                this.selectedProduct.quantity = (parseFloat(this.selectedProduct.sqr_qnty) * parseFloat(this
                    .selectedProduct.height) * parseFloat(this.selectedProduct.width)).toFixed(2);
                this.productTotal();
            }
        },
        productTotal() {
        ...
        addToCart() {
            let product = {
                ...
                sqr_qnty: this.selectedProduct.sqr_qnty,
