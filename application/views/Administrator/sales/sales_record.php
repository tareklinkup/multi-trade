					...
					<tbody>
						<template v-for="sale in sales">
							<tr>
								...
								<td style="text-align:center;" v-if="sale.saleDetails[0].height != 0">{{ sale.saleDetails[0].height }} * {{ sale.saleDetails[0].width }}</td>
								<td style="text-align:center;" v-else>-</td>
								<td style="text-align:center;">{{sale.saleDetails[0].sqr_qnty }}</td>
							...
							<tr v-for="(product, sl) in sale.saleDetails.slice(1)">
								...
								<td style="text-align:center;" v-if="product.height != 0">{{ product.height }} * {{ product.width }}</td>
								<td style="text-align:center;" v-else>-</td>
